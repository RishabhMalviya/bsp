...
from bsp.stable_baselines3.common.vec_env.base_vec_env import VecEnv, VecEnvIndices, VecEnvObs, VecEnvStepReturn
from bsp.stable_baselines3.common.vec_env.patch_gym import _patch_env
from bsp.stable_baselines3.common.vec_env.util import dict_to_obs, obs_space_info
...
class DummyVecEnv(VecEnv):
    ...
    def env_is_wrapped(self, wrapper_class: type[gym.Wrapper], indices: VecEnvIndices = None) -> list[bool]:
        ...
        from bsp.stable_baselines3.common import env_util
